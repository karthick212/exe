            ...
            <td width="346"> <table width="246" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                ;"><b>Reg.No:
                 ...
                 <?php 
                {
                 echo '<a href=edit_profile.php?id='.$mat_id.'><button class="btn-hover color-10" id="print">Edit Profile</button></a><br>';
                }
                ?>
    ...
    <tr class="heig">
      ...
      <tr class="heig">
        ...
        <tr class="heig">
         ...
         <td class="tdheader">:</td>
         <td width="250" class="tdvalue"><?php echo  'Elder:'.$row['sis'].'&nbsp;/&nbsp;Younger:'.$row['ysister'];?></td>
       </tr>
       <tr class="heig"></tr>
