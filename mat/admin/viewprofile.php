...
<html class=""><head>
  ...
  <script type="text/javascript">     
    function PrintDiv() {    
     ...
     popupWin.document.write('<html><head><style>td{font-size: 17px !important;}.tdvalue{padding-left:3px;  font-size:16px;  vertical-align:top;   font-family: Helvetica, sans-serif; } .tdheader{  padding-left:0px;  font-size:16px;font-weight: bold;vertical-align:top; } .print:last-child {page-break-after: auto;}@page{size:auto; margin:3mm;}.tblborder{  padding-left: 5px;padding-right: 10px; word-spacing: 15;border-style: solid;border-width: 3px;background-color: white;font-size:16px;width:90px;height:90px;}td textarea{border-color:black!important;font-size:21px;}#table6{margin-top:-10px !important;}#table5{padding-top:120px;padding-bottom: 30px; !important;} tr.heig td{font-size:21px !important;padding-bottom:5px !important; line-height:28px !important; font-weight:bold;}tbody.b{margin-top}</style></head><body style="margin-top:170px;margin-left:40px; line-height:100px;font-family:Arial !important;font-weight:normal !important;" onload="window.print()">' + divToPrint.innerHTML + '</html>');
      ...
      <tr>
        <td height=""><table width="1003" id="table5" height="" border="0">
          ...
          <tr align="center">
            ...
            ?>
            <td width="200" height="" align="left"> <img src="<?php echo $row['up_profile']; ?>" style=" border: 2px solid #a4214a;" height="300px" width="230px" /></td>
            <td width:"400">

              <img style="margin-left: 40px;" src="images/images/LOGOss.png" alt="Wedding Vendors" class="img-responsive" style="">
          ...
          <td width="346"> <table width="246" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              ;"><b>Reg.No:
               ...
               <a href="a_edit_profile.php?id=<?php echo $mat_id; ?>"><button class="btn-hover color-10" id="print">Edit Profile</button></a><br>
...
<div id="divToPrint" style="margin: 0px 67px;">
  <td height=""><table width="1003" id="table5" border="0" />
    <tr class="heig">
      <td width="200" height="29" align="left" class="tdheader">Reg.No</td>
      <td width="11"  class="tdheader">:</td>
      <td width="300" class="tdvalue" style="font-weight: bold;"><?php echo  $mat_id;?></td>
      <td width="1">&nbsp;</td>
      <td width="200" align="left" class="tdheader">Date</td>
      <td width="10" class="tdheader">:</td>
      <td width="200"   class="tdvalue"><?php echo date('d/m/Y');?></td>
    </tr>
    <tr class="heig">
      <td width="200" height="29" align="left" class="tdheader">Name</td>
      <td width="11"  class="tdheader">:</td>
      <td width="300" class="tdvalue"><?php echo  $row['name'];?></td>
      <td width="1">&nbsp;</td>
      <td width="200" align="left" class="tdheader">Sex</td>
      <td width="10" class="tdheader">:</td>
      <td width="200"   class="tdvalue"><?php echo  $row['gender'];?></td>
    </tr>
    <tr class="heig"></tr>
    <tr class="heig">
      <td width="227" height="29" align="left" class="tdheader">Religion</td>
      <td class="tdheader">:</td>
      <td width="311"   class="tdvalue"><?php echo  $row['religion'];?></td>
      <td width="1" class="tdheader">&nbsp;</td>
      <td width="163" align="left" class="tdheader">Caste</td>
       <td class="tdheader">:</td>
      <td width="200" class="tdvalue"><?php echo  $row['caste'];?></td>
    </tr>
    <tr class="heig"></tr>
    <tr class="heig">
      <td width="227" height="29" align="left" class="tdheader">Sub Caste</td>
       <td class="tdheader">:</td>
      <td width="311" class="tdvalue"><?php echo  $row['subcaste'];?></td>
      <td width="1">&nbsp;</td>
      <td width="163" align="left" class="tdheader">Martial Status</td>
       <td class="tdheader">:</td>
      <td width="200" class="tdvalue"><?php echo  $row['mstatus'];?></td>
    </tr>
    <tr class="heig"></tr>
    <tr class="heig">
      <td width="227" height="29" align="left"  class="tdheader">Date Of Birth/Age</td>
       <td class="tdheader">:</td>
      <td width="311" class="tdvalue"><?php echo  $row['dob'];?> (<?php
        ...
        ?>)</td>
      <td width="1">&nbsp;</td>
      <td width="163" align="left" class="tdheader">God</td>      
       <td class="tdheader">:</td>       
      <td width="200" class="tdvalue">
        <?php echo  $row['god'];?>
        </td>
      </tr>
      <tr class="heig"></tr>
      ...
      <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Birth Time</td>
         <td class="tdheader">:</td>
        ...
        ?></td>
        <td width="1">&nbsp;</td>
        <td width="163" align="left" class="tdheader">Birth Place</td>
         <td class="tdheader">:</td>
        <td width="200" class="tdvalue">
          <?php
        ...
        <tr class="heig"></tr>
        <tr class="heig">
          <td width="227" height="29" align="left"  class="tdheader">Edu. Qualification</td>
           <td class="tdheader">:</td>
          <td width="311" class="tdvalue"><?php echo $row['edu'];?></td>
          <td width="1">&nbsp;</td>
          <td width="163" align="left" class="tdheader">Height</td>
           <td class="tdheader">:</td>
          <td width="200"  class="tdvalue"><?php echo  $row['height'];?>&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr class="heig"></tr>
        <tr class="heig">
          <td width="227" height="29" align="left" class="tdheader">Job/Business</td>
           <td class="tdheader">:</td>
          <td width="311"  class="tdvalue"><?php echo  $row['working_place'];?></td>
          <td width="1">&nbsp;</td>
          <td width="163" align="left" class="tdheader">Monthly Salary</td>
           <td class="tdheader">:</td>
          <td width="200"  class="tdvalue"><?php echo  $row['monthlyincome'];?></td>
        </tr>
        <tr class="heig"></tr>

        <tr class="heig">
          <td width="227" height="29" align="left" class="tdheader">Father Name</td>
           <td class="tdheader">:</td>
          <td width="311" class="tdvalue"><?php echo  $row['father_name'];?></td>
          <td width="1">&nbsp;</td>
          <td width="163" align="left" class="tdheader">Mother Name</td>
           <td class="tdheader">:</td>
          <td width="200" class="tdvalue"><?php echo  $row['mother_name'];?></td>
        </tr>
        <tr class="heig"></tr>
        <tr class="heig">
          <td width="227" height="29" align="left" class="tdheader">Father Occp.</td>
           <td class="tdheader">:</td>
          <td width="311" class="tdvalue"><?php echo  $row['father_occ'];?></td>
          <td width="1">&nbsp;</td>
          <td width="163" align="left" class="tdheader">Mother Occp.</td>
           <td class="tdheader">:</td>
          <td width="200" class="tdvalue"><?php echo  $row['mother_occ'];?></td>
        </tr>
        <tr class="heig"></tr>
        <tr class="heig">
         <td width="227" height="29" align="left" class="tdheader">Brother's</td>
          <td class="tdheader">:</td>
         <td width="311"  class="tdvalue"><?php echo 'Elder:'.$row['bro'].'&nbsp;/&nbsp;Younger:'.$row['ybrother'];?></td>
         <td width="1">&nbsp;</td>
         <td width="163" align="left" class="tdheader">Sister's</td>
          <td class="tdheader">:</td>
         <td width="200" class="tdvalue"><?php echo  'Elder:'.$row['sis'].'&nbsp;/&nbsp;Younger:'.$row['ysister'];?></td>
       </tr>
       <tr class="heig"></tr>
       ...
       <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Family Status</td>
         <td class="tdheader">:</td>
        <td width="311" class="tdvalue"><?php echo  $row['f_status'];?></td>
        <td width="1">&nbsp;</td>
        <td width="163" align="left" class="tdheader">City</td>
         <td class="tdheader">:</td>
        <td width="200" class="tdvalue"><?php echo  $row['city'];?></td>
      </tr>
      <tr class="heig"></tr>
      <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Rasi</td>
         <td class="tdheader">:</td>
        <td width="311" class="tdvalue"><?php echo  $row['rasi'];?></td>
        <td width="1">&nbsp;</td>
        <td width="163" align="left" class="tdheader">Star</td>
         <td class="tdheader">:</td>
        <td width="200" class="tdvalue"><?php echo  $row['star'];?></td>
      </tr>
      <tr class="heig"></tr>
      <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Lagnam</td>
         <td class="tdheader">:</td>
        <td width="311" class="tdvalue"><?php echo  $row['lagnam'];?></td>
        <td width="1">&nbsp;</td>
        <td width="163" align="left" class="tdheader">Thesai</td>
         <td class="tdheader">:</td>
        <td width="200"  class="tdvalue"><?php echo  $row['thisai'];?></td>        
      </tr>
      <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Expectation</td>
        <td class="tdheader">:</td>
        <td colspan="5" width="311" class="tdvalue"><?php echo  $row['expectation'];?></td>
        <td width="1">&nbsp;</td>
      </tr>
      <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Address</td>
        <td class="tdheader">:</td>
        <td colspan="5" width="311" class="tdvalue"><?php echo  $row['address'];?></td>
        <td width="1">&nbsp;</td>
      </tr>
      <tr class="heig">
        <td width="227" height="29" align="left" class="tdheader">Contact</td>
        <td>:</td>
        <td width="311" colspan="5" class="tdvalue"><?php echo  $row['mobile'];?></td>
        <!-- <td width="1">&nbsp;</td>
        <td width="163" align="left" class="tdheader">Email</td>
        <td>:</td>
        <td width="200" style=";font-size:16px;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?>"><?php echo  $row['email'];?></td> -->
      </tr>
      <tr class="heig"></tr>
      ...
      <!-- <tr>
        <td width="227" height="29" align="left"  style="padding-left:0px;font-size: 16px;;">Address</td>
        <td>:</td>
        <td width="311" style=";font-size:18px;"><?php echo  $row['address'];?></td>
        <td width="1">&nbsp;</td>
         <td width="163" align="left" style="padding-left:0px;font-size: 16px;;">Phone no:</td>
        <td>:</td>
        <td width="200" style=";font-size:18px;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?>">
          <?php
          echo $row['mobile'];
?></td>
</tr>-->
